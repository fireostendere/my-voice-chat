...
По умолчанию рация использует `F8`. Для поиска другого имени клавиши откройте в меню
«Пуск» папку **LiveKit Companion** и выберите **Настроить клавишу рации**, затем при
необходимости измените `PTT_KEY` в установленном `start-companion.cmd`.
