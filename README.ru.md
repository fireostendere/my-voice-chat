...
Ярлык **LiveKit Companion** запускает фоновый сервис и открывает локальное окно
управления. В нём можно выбрать активную комнату, передать magnet-ссылку или файл
